...
function builder(options) {
  ...
  if (!options.network) {
    options.network = digibyte.Networks.defaultNetwork;
  }

  options.Block = options.Block || digibyte.Block;
  options.BlockHeader = options.BlockHeader || digibyte.BlockHeader;
  options.Transaction = options.Transaction || digibyte.Transaction;
  options.MerkleBlock = options.MerkleBlock || digibyte.MerkleBlock;
  options.protocolVersion = options.protocolVersion || 700015;
